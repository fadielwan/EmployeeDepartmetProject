					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="<c:url value="/viewDept"/>" class="dropdown-toggle "
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<c:url value="/manageDept"/>">Add Departments</a></li>
							</ul></li>
						<li class=" dropdown"><a href="#" class="dropdown-toggle "
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<c:url value="/manageEmp"/>">Add Employee and Assign (Department)</a></li>
							</ul></li>
							<li class=" dropdown"><a href="#" class="dropdown-toggle "
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false">Project <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/viewProject"/>">View Project</a></li>
								<li><a href="<c:url value="/manageProject"/>">Add Project And Assign(Employees)</a></li>
							</ul></li>
					</ul>
